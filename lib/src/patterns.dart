...
class WhatsAppPatterns {
  ...
  /// Universal
  static const String universal = startOfLine + date + r"(,\s?|\s|،\s?)" + time + r"(\]\s?-?|:|\s-)\s" + sender + r":\s" + content + endOfLine;
  ...
  /// System Universal
  static const String systemUniversal = startOfLine + date + r"(,\s?|\s)" + time + r"(\]\s?-?|:|\s-)\s" + r"(" + sender + r":\s" + r")?" + content + endOfLine;
  ...
  static String _foursquareLocationPattern = r"^(?<place>.*\(?.*\)?):?\s(?<link>https://foursquare.com.*)\b" + endOfLine;
